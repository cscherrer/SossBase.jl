...
(β = Particles{Float64,1000}[0.567 ± 0.27, 0.756 ± 0.5],)
...
symlogpdf(m2)
                                                   ...
                                                   ╲                    
                                                    ╲                   
-0.918938533204673⋅N - 0.918938533204673⋅k - 0.5⋅   ╱    (y[_j1] - 1.0⋅y
                                                   ╱                    
                                                   ‾‾‾                  
                                                 _j1 = 1                
...
@btime logpdf($m2(X=X), $truth)
  1.964 μs (47 allocations: 1.05 KiB)
-15.84854642585797

julia> @btime logpdf($m2(X=X), $truth, $codegen)
  326.777 ns (5 allocations: 208 bytes)
-15.848546425857968
